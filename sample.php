...
use laravel_datatable\LaravelDatatable;
...
$columns = array(
        ...
        $dataTable = new LaravelDatatable($this->users,$this->request);
        return $dataTable->columns($columns)->sortable($sortable)->process()->render($result);